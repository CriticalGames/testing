...
public class MainMenuNew : MonoBehaviour {
    ...
    public GameObject AboutCompanyPanel;
    public GameObject AboutGamePanel;
    public GameObject AboutSponsorPanel;

    public GameObject DataKitGamePanel;
    ...
    [Tooltip("The Menu for when the ABOUT button is clicked")]
    ...
    //SubMenu About
    [Header("About Sub Buttons")]
    public GameObject aboutCompany;
    public GameObject aboutGame;
    public GameObject aboutSponsors;
    ...
    public void About()
    {
        ...
        AboutCompanyPanel.gameObject.SetActive(false);
    }

    public void AboutCompany()
    {
        AboutCompanyPanel.gameObject.SetActive(true);
        AboutSponsorPanel.gameObject.SetActive(false);
        AboutGamePanel.gameObject.SetActive(false);
    }

    public void AboutGame()
    {
        AboutGamePanel.gameObject.SetActive(true);
        AboutSponsorPanel.gameObject.SetActive(false);
        AboutCompanyPanel.gameObject.SetActive(false);
    }

    public void AboutSponsor()
    {
        AboutSponsorPanel.gameObject.SetActive(true);
        AboutCompanyPanel.gameObject.SetActive(false);
        AboutGamePanel.gameObject.SetActive(false);
    }
    ...
    {
        DataKitGamePanel.gameObject.SetActive(true);
        AboutCompanyPanel.gameObject.SetActive(false);
        AboutSponsorPanel.gameObject.SetActive(false);
        AboutGamePanel.gameObject.SetActive(false);
    ...
    public void DisableAboutCampaign()
    {
        aboutMenu.gameObject.SetActive(false);
        AboutCompanyPanel.gameObject.SetActive(false);
        AboutSponsorPanel.gameObject.SetActive(false);
